...
const server = Bun.serve<WebSocketData>({
  ...
  websocket: {
    open(ws) {
      let openMsg = new Message(SERVER_NAME, ws.data.username, MessageType.SOCKET_OPENED);
      let nameMsg = new Message(SERVER_NAME, ws.data.username, MessageType.SOCKET_ID);
    ...
    close(ws) {
      let closeMsg = new Message(SERVER_NAME, ws.data.username, MessageType.SOCKET_CLOSED);
